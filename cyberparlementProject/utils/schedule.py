...
from cyberparlementProject.models import Initiative, Choixinitiative
...
def schedule_poll_start(initiative_id):
    ...
    schedule(
        'cyberparlementProject.utils.schedule.open_poll',
        initiative_id,
...
def schedule_poll_end(initiative_id):
    ...
    schedule(
        'cyberparlementProject.utils.schedule.close_poll',
        initiative_id,
